...
global WDIM ODIM PDIM CDIM VDIM DDIM BDIM RDIM IDIM
...
maxIdp     =  20;   % Maximum number of rays
maxPnt     =  080;  % Maximum number of points
simultIdp  =  7;    % Maximum simultaneous ray updates
...
lostIdpTh  = 8;    % ray 'lost' counter threshold for deletion
...
Rho.rho    = 1/3;   % inverse depth
Rho.RHO    = 1/6^2; % variance
