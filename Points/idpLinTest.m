function Ld = idpLinTest(Rob,Sen,Lmk)

% IDPLINTEST  Linearity test of cartesian point given inverse depth point
%   LD = IDPLINTEST(ROB,SEN,LMK) return a value with the result of the
%   linearity test.
