...
% moreindatatip
%
% Extends the displayed text of the datatip to get the index of the clicked point.
% The extension remains until the figure is deleted.
% If datatip(s) was previously present, a message prompts the user to right-click on the figure to delete
% all datatips in order to switch on the capabilities of the datatip.
%
% may 2006
