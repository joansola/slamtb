...
%         aviVideoSide  = initAviFile(videoFileMapSide,fig1,[],videoPosMap,opt);
    ...
    case 2 % images sequence
        ...
        seqFileMapTop = [expdir 'video/sequences/' experim '-map-top-%04d.png'];
        seqFileMapSide = [expdir 'video/sequences/' experim '-map-side-%04d.png'];
        set(fig1,'pos',videoPosMap);
        imgFrame(fig1,sprintf(seqFileMapTop,fmin-1));
%         camorbit(ax1,0,-90)
%         imgFrame(fig1,sprintf(seqFileMapSide,fmin));
%         camorbit(ax1,0,90)
        seqFileImg = [expdir 'video/sequences/' experim '-img-%04d.png'];
