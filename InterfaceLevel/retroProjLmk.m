...
switch Sen.type
    ...
    case {'pinHole'}
        ...
        switch Opt.init.initType
            ...
            case {'papPnt'}
                % INIT LMK OF TYPE: Parallax Angle Parametrization point
                % NOTE: papPnt in reduced form is equal to idpPnt w/o
                % inverse depth.
                % TODO: Change the fixed value below to a value selected
                % through options
                [idp, L_rf, L_sf, L_k, L_c, L_obs, ~] = ...
                    retroProjIdpPntFromPinHoleOnRob( ...
                    Rob.frame, ...
                    Sen.frame, ...
                    Sen.par.k, ...
