function Obs = apluckerInnovation(Obs,Cam,Line,innSpace)

% APLUCKERINNOVATION Anchor Plucker line innovation.
%   OBS = APLUCKERINNOVATION(OBS,CAM,LINE,INNSPACE) computes
...
[hm,HM_c,HM_k,HM_l] = projectAPlucker(Cam.X,Cam.cal,line);
HM_c_l = [HM_c HM_l];
