...
for sen = 1:numel(Sen)
    ...
    set(SenFig(sen).fig,...
        ...
        'doublebuffer', 'on',...
        'color',        FigureOptions.senCol.border,...
    ...
    switch Sen(sen).type
        ...
        case {'pinHole'}
            ...
            set(SenFig(sen).axes,...
                'position',      [.05 .05 .9 .9],...
                'color',         FigureOptions.senCol.bckgnd,...
                'box',           'on',...
                ...
                'layer',         'top',...
                'fontsize',      9,...
                'xcolor',        FigureOptions.senCol.axes,...
                'ycolor',        FigureOptions.senCol.axes,...
                'zcolor',        FigureOptions.senCol.axes);
            ...
            SenFig(sen).raw = line(...
                ...
                'xdata',         [],...
                'ydata',         [],...
                'color',         FigureOptions.senCol.raw,...
                'linestyle',     'none',...
                'marker',        '+');
            ...
            for lmk = 1:size(Obs,2)
                ...
                SenFig(sen).label(lmk) = text(...
                    ...
                    'position',           [50 50],...
                    'string',             num2str(lmk),...
                    'color',              FigureOptions.senCol.label,...
